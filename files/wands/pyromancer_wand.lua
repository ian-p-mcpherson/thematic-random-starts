...
local wand = { }
wand.name = {"pyromancer_wand"}
wand.deck_capacity = {3,3}
wand.actions_per_round = 1
wand.reload_time = {65,75}
wand.shuffle_deck_when_empty = 2
wand.fire_rate_wait = {17,20}
wand.spread_degrees = {7,10}
...
AddGunAction( entity_id, "FIRE_TRAIL" )
